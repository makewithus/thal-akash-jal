...
base_dir = r"c:\Downloaded Web Sites\metisaerospace.com"

footer_template = """      <div data-w-id="5f665b38-6c9c-f7d6-e5a1-ac5999256cdf" class="footer">
        <div class="footer-contain">
          <div class="spacer__footer"></div>
          <div class="footer-wrapper">
            <div class="footer-left-block">
              <div class="footer__heading-flexbox"><img
                  src="{prefix}6893263d1e27013b67b77d36/6894a9853735d270b7c293a4_blue%20triangle.svg" loading="lazy" alt="">
                <h3 class="my-0">Where To Find Us</h3>
              </div>
              <div class="text-wrapper">
                <p class="mb-0">Corporate Office<br>Office No. 11, Manorama Chambers<br>S.V. Road, Bandra West<br>Mumbai – 400050</p><a href="tel:+919310315950">+91 93103 15950</a><a
                  href="mailto:info@tajdefence.com" class="text-word-wrap">info@tajdefence.com</a>
              </div>
            </div>
            <div class="footer__divider-wrapper">
              <div class="footer__divider"></div><img
                src="{prefix}6893263d1e27013b67b77d36/6894865441bece15ca029088_White%20Icon.svg" loading="lazy" alt="">
              <div class="footer__divider"></div>
            </div>
            <div class="footer-right-block">
              <div class="footer__right-block-wrapper">
                <div class="footer-right-block-item">
                  <div class="footer__heading-flexbox"><img
                      src="{prefix}6893263d1e27013b67b77d36/6894a9853735d270b7c293a4_blue%20triangle.svg" loading="lazy"
                      alt="">
                    <h3 class="my-0">Our Services</h3>
                  </div>
                  <div class="w-dyn-list">
                    <div role="list" class="footer__link-list w-dyn-items">
                      <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/strategic-advisory.html">Strategic Advisory</a></div>
                      <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/logistics-supply-chain.html">Supply Chain Consulting</a></div>
                      <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/procurement-contract-management.html">Procurement Management</a></div>
                      <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/gem-advisory.html">GeM Advisory</a></div>
                      <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/warehouse-management.html">Warehouse Optimization</a></div>
                      <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/human-capital-workforce.html">Workforce Analytics</a></div>
                      <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/outsourced-business-management.html">Business Management</a></div>
                      <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/marine-aqua-tourism.html">Marine Tourism</a></div>
                      <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/technology-transfer.html">Technology Transfer</a></div>
                      <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/strategic-liaison.html">Strategic Liaison</a></div>
                      <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/field-trial-management.html">Field Trial Management</a></div>
                      <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/specification-review.html">Specification Review</a></div>
                    </div>
                  </div>
                </div>
                <div class="footer__right-block-wrapper-down">
                  <div class="footer-right-block-item">
                    <div class="footer__heading-flexbox"><img
                        src="{prefix}6893263d1e27013b67b77d36/6894a9853735d270b7c293a4_blue%20triangle.svg" loading="lazy"
                        alt="">
                    ...
                    <div class="w-dyn-list">
                      <div role="list" class="footer__link-list w-dyn-items">
                        <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/strategic-advisory.html">Defence Consultancy</a></div>
                        <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/gem-advisory.html">GeM &amp; Procurement</a></div>
                        <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/logistics-supply-chain.html">Supply Chain Management</a></div>
                        <div role="listitem" class="w-dyn-item"><a href="{prefix}sector/technology-transfer.html">Make in India Facilitation</a></div>
                      </div>
                    </div>
                  </div>
                  <div class="footer-right-block-item">
                    <div class="footer__heading-flexbox"><img
                        src="{prefix}6893263d1e27013b67b77d36/6894a9853735d270b7c293a4_blue%20triangle.svg" loading="lazy"
                        alt="">
                      <h3 class="my-0">Follow us</h3><a rel="noreferrer, noopener, nofollow" aria-label="Linkedin"
                        href="https://uk.linkedin.com/company/metis-aerospace-ltd" target="_blank"
                        class="w-inline-block"><img src="{prefix}6893263d1e27013b67b77d36/6894b936de5d4d0919e496ea_Linkedin.svg"
                          loading="lazy" alt=""></a>
                    </div>
                  </div>
                </div>
          ...
          <div class="footer__bottom-links">
            <div class="footer__bottom-left-links">
              <p class="text-style-footer-bottom">© 2026 THAL AKASH JAL DEFENCE TECHNOLOGIES PVT. LTD. | All Rights Reserved</p>
            </div>
            <div class="footer__bottom-right-links"><a href="{prefix}privacy-policy.html"
                class="text-style-footer-link-bottom">Privacy Policy</a>
              <div class="display-none">
                <div>|</div><a href="{prefix}privacy-policy.html" class="text-style-footer-link-bottom">Terms
                  &amp; Conditions</a>
              </div>
            </div>
          </div>
          <div class="spacer__2"></div>
        </div>
      </div>"""

feature_template = """                    <div class="expertise__solutions-wrapper">
...
with open(os.path.join(base_dir, "index.htm"), "r", encoding="utf-8") as f:
    index_content = f.read()

nav_match = re.search(r'(<div class="navbar-wrapper">.*?)<div class="main">', index_content, re.DOTALL)
if not nav_match:
    print("Could not find navbar in index.htm")
    exit(1)

base_navbar = nav_match.group(1)

def fix_nav_links(html, prefix):
    def repl_path(m):
        attr = m.group(1)
        val = m.group(2)
        if val.startswith(('http', '#', 'mailto:', 'tel:', prefix, '../')):
            return m.group(0)
        return f'{attr}="{prefix}{val}"'
    html = re.sub(r'(href|src)="([^"]+)"', repl_path, html)
    html = html.replace('href="../index.htm" aria-current="page" class="logo-link w-nav-brand w--current"', 'href="../index.htm" class="logo-link w-nav-brand"')
    return html
...
for root, dirs, files in os.walk(base_dir):
    for f in files:
        if f.endswith('.html') or f.endswith('.htm'):
            ...
            if '.gemini' in filepath or 'node_modules' in filepath:
                continue
            ...
            # --- FOOTER ---
            footer_regex = r'<div[^>]*class="footer"[^>]*>.*?(?=\s*<script src=")'
            footer_replacement = footer_template.format(prefix=prefix) + '\\n'
            
            content = re.sub(footer_regex, footer_replacement, content, flags=re.DOTALL)
            
            # --- NAVBAR (For all files except index.htm to avoid recursive issues) ---
            if relPath != "index.htm":
                nav_regex = r'<div class="navbar-wrapper">.*?<div class="main">'
                new_nav = fix_nav_links(base_navbar, prefix) + '<div class="main">'
                content = re.sub(nav_regex, new_nav, content, flags=re.DOTALL)
                
            # --- SECTOR SPECIFIC (Feature Section & Hero Title) ---
            if depth > 0 and 'sector' in relPath.lower():
                filename = os.path.basename(filepath)
                
                # 1. Inject Feature Section
                if filename in features_data:
                    data = features_data[filename]
                    feature_html = feature_template.format(**data)
                    
                    clean_regex = r'<div class="expertise__solutions-wrapper">.*?</div>\s*</div>\s*</div>\s*<div class="spacer__main"></div>\s*'
                    content = re.sub(clean_regex, '', content, flags=re.DOTALL)
                    
                    inject_regex = r'(<div [^>]*class="expertise-solutions__content">)'
                    replacement = feature_html + '\\n                    <div class="spacer__main"></div>\\n                    \\1'
                    content = re.sub(inject_regex, replacement, content, count=1)
                
                # 2. Update Hero Section Titles
                if filename in titles_mapping:
                    title = titles_mapping[filename]
                    content = re.sub(r'(<p[^>]*class="text-style-solution-subheading"[^>]*>).*?(</p>)', r'\g<1>Our Services\g<2>', content, count=1)
                    content = re.sub(r'(<h1[^>]*>).*?(</h1>)', r'\g<1>' + title + r'\g<2>', content, count=1, flags=re.DOTALL)
            ...
            if content != original:
                ...
                print(f"No changes made to {relPath}")
